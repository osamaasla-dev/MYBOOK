  ...
  return (
    <div ref={containerRef} className={cn("relative w-full", className)}>
      ...
      {shouldShowDropdown ? (
        <>
          {isFetching ? (
            <div className="absolute left-1/2 top-full z-40 mt-2 flex -translate-x-1/2 items-center gap-2 rounded-full bg-muted/80 px-3 py-1 text-xs text-muted-foreground shadow">
